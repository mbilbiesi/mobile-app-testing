...
public class CheckoutScreenSteps extends CheckoutScreen {
    ...
    public void verifyAmountsOnCheckoutScreen(double expectedOrderAmount, double expectedDeliveryAmount) {
        ...
        soft.assertThat(expectedOrderAmount)
                .as(String.format("Actual order amount is [%s] instead of [%s]",
                        actualOrderAmount, expectedOrderAmount))
                .isEqualTo(expectedOrderAmount);
        soft.assertThat(actualDeliveryAmount)
                .as(String.format("Actual delivery amount is [%s] instead of [%s]",
